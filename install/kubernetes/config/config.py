...
def connect_sql(config_data, sql, db_host, db_tag=""):
    try:
...
def updater(config_data, db_host):
    ...
    connect_sql(config_data, config_sql, db_host)
    ...
    connect_sql(config_data,api_sql,db_host,db_tag="kong")
    root_path = os.path.abspath(os.path.join(os.getcwd(), "../../.."))
    ssl_cert_path = root_path + "/install/kubernetes/j2_conf/kong/edgescale.crt"
    ssl_key_path = root_path + "/install/kubernetes/j2_conf/kong/edgescale.key"
    ...
    connect_sql(config_data, cert_sql, db_host, db_tag="kong")
