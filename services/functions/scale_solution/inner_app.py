...
from edgescale_pyutils.exception_utils import DCCAException, InvalidInputException, EdgeScaleException
from view.solution_views import solution_bp


inner_app = Flask(__name__)
inner_app.config["JSON_AS_ASCII"] = False

inner_app.register_blueprint(solution_bp, url_prefix="/solutions")
...
if __name__ == '__main__':
    inner_app.run(debug=IS_DEBUG, port=5003)
